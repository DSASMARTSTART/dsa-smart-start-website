...
INSERT INTO courses (
  ...
  '[{"id": "mod-a1-1", "title": "Getting Started", "description": "Introduction to English basics", "lessons": [], "order": 1}]',
  true,
  false,
  NOW(),
  NOW()
...
INSERT INTO courses (
  ...
  '[{"id": "mod-a2-1", "title": "Everyday Conversations", "description": "Master daily communication", "lessons": [], "order": 1}]',
  true,
  false,
  NOW(),
  NOW()
...
INSERT INTO courses (
  ...
  '[{"id": "mod-b1-1", "title": "Professional Communication", "description": "English for work and study", "lessons": [], "order": 1}]',
  true,
  false,
  NOW(),
  NOW()
...
INSERT INTO courses (
  ...
  '[{"id": "mod-b2-1", "title": "Advanced Fluency", "description": "Master complex English", "lessons": [], "order": 1}]',
  false,
  true,
  NOW(),
  NOW()
