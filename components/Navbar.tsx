                  ...
                  <div className="absolute top-full right-0 mt-4 w-48 bg-white rounded-2xl shadow-2xl border border-gray-100 p-2 overflow-hidden animate-reveal">
                    {isAdmin && (
                      <button 
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-[11px] font-black uppercase text-purple-600 hover:bg-purple-50 rounded-xl transition-all"
                      >
                        <Shield size={14} />
                        Admin Panel
                      </button>
